...
#define WLAN_SSID       "TigoWifi bridge"     //your SSID

#define WLAN_PASS       "Yeahjesus9!"         //your password
...
Adafruit_MQTT_Subscribe boton_led2 = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/boton_led2", MQTT_QOS_1);   //boton_led is the name of the widget
...
void boton_led2callback(char *data, uint16_t len) {
  ...
  String message = String(data);
      ...
      if (message == "ON") {digitalWrite(D1, LOW);}    //D0 is the I/O port

      if (message == "OFF") {digitalWrite(D1, HIGH);}}
...
void setup() {
  ...
  boton_led2.setCallback(boton_led2callback);
